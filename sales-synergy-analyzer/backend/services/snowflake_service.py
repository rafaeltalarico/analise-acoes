...
# CEO comp esperado por faixa de market cap — calibrado com NVDA (falhou, pares ~$14.65M)
# e GOOGL (passou, comp reportada $10.91M). Tolerância de 30% acima do teto da faixa.
...
# ---------------------------------------------------------------------------
# DCF simplificado (2 estágios, CAPM) — usado nos 2 primeiros checks de Value
# ---------------------------------------------------------------------------
